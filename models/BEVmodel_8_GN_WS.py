...
def Head(entry_layer):
    ...
    last_conf = Conv2D(128, (1, 1), padding = 'valid', name="occ1", kernel_regularizer=ws_reg, kernel_initializer = tf.keras.initializers.HeNormal())(entry_layer)
    ...
    last_rot = Conv2D(16, (1, 1), padding = 'valid', name="rot1", kernel_regularizer=ws_reg, kernel_initializer = tf.keras.initializers.HeNormal())(entry_layer)
