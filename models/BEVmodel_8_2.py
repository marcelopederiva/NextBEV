...
def Head(entry_layer):
    ...
    last_conf = Conv2D(128, (1, 1), padding = 'valid', name="occ1", activation="relu")(entry_layer)
    ...
    last_rot = Conv2D(16, (1, 1), padding = 'valid', name="rot1", activation="relu")(entry_layer)
