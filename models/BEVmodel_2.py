...
def Head(entry_layer):
    ...
    last_conf = Conv2D(32, (3,3), padding = 'same', name="occ1", activation="relu")(entry_layer)
    ...
    last_pos = Conv2D(32, (3,3), padding = 'same', name="loc1", activation="relu")(entry_layer)
    ...
    last_dim = Conv2D(32, (3,3), padding = 'same', name="size1", activation="relu")(entry_layer)
    ...
    last_rot = Conv2D(32, (3,3), padding = 'same', name="rot1", activation="relu")(entry_layer)
