...
from models.MobileNetv3large import My_Model
...
weights_path = 'checkpoints/val_loss/Temp_loss/model_180_MobileNetv3large_minimum.hdf5'
# weights_path = 'checkpoints/val_loss/BEVmodel_8_GN_WS_best.hdf5'
###############################-
...
def detect(data, label_path):
    ...
    while bboxes:
        ...
        for box in bboxes:
            ...
            if iou2d(chosen_box[1:-1], box[1:-1]) < 0.1:
